...
const ROLE_DEFINITIONS = [
  {
    ...
    permissions: {
      ...
      appointments: ["read", "create", "update", "edit", "attend", "cancel", "reschedule", "delete"],
      clients: ["read", "create", "update", "edit", "delete"],
      pets: ["read", "create", "update", "edit", "delete", "viewClinicalHistory"],
      today: ["read", "create", "update", "delete"],
      todayTurn: ["read", "create", "update", "delete"],
      services: ["read", "create", "update", "delete"],
      inventory: ["read", "create", "update", "delete"],
      inventoryMovements: ["read", "create"],
      encounters: ["manage", "addConsumptions"],
      visits: ["read", "create", "update", "edit", "attachDocuments"],
      vaccines: ["read", "create", "update", "edit"],
      invoices: ["read", "viewDrafts", "create", "update", "edit", "issue", "annul", "sendToBilling", "download", "print", "delete"],
  ...
  },
  {
    ...
    permissions: {
      ...
      roles: ["read", "manage"],
      appointments: ["read", "create", "update", "edit", "attend", "cancel", "reschedule", "receiveUnassignedNowAlerts", "assign"],
      clients: ["read", "create", "update", "edit"],
      pets: ["read", "create", "update", "edit", "viewClinicalHistory"],
      ...
      visits: ["read", "create", "update", "edit", "attachDocuments"],
      vaccines: ["read", "create", "update", "edit"],
      invoices: ["read", "viewDrafts", "create", "update", "edit", "issue", "annul", "sendToBilling", "download", "print"],
      payments: ["read", "register"],
    },
  },
  {
    ...
    permissions: {
      appointments: ["read", "update", "attend"],
      clients: ["read", "update", "edit"],
      pets: ["read", "update", "edit", "viewClinicalHistory"],
      today: ["read", "update"],
  ...
  },
  {
    ...
    permissions: {
      appointments: ["read", "create", "update", "edit", "cancel", "reschedule", "receiveUnassignedNowAlerts", "assign"],
      clients: ["read", "create", "update", "edit"],
      pets: ["read", "create", "update", "edit"],
      today: ["read", "create", "update"],
      todayTurn: ["read", "create", "update"],
      services: ["read"],
      inventory: ["read"],
